...
int Line_match::query_count = 0;

Line_match::Line_match(int queryNodeNum, int queryEgdeNum, int queryNum, Graph* _data)
{
	this->data = _data;
...
bool 
Line_match::isDuplicate(std::vector<int*>& query_set, vector<int>& vlabel, std::vector<std::pair<int,int>*>& edges, std::vector<int>& elabel)
{
...
void 
Line_match::match(std::string _query_dir)
{
